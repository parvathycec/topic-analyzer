...
Note:
We had an issue with the progress bar not showing up when needed and the gui app freezes(going to Not responding state) even when the program is running fine,
to solve this, we checked in google and made it as multi threading
